    ...
    <section ref={containerRef} className="relative py-28 border-b border-white/[0.06] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto text-center space-y-4 mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white/[0.03] border border-white/[0.08] text-xs font-mono text-emerald-400">
          ...
          <p className="text-sm sm:text-base text-slate-400 leading-relaxed font-normal">
            Inspired by autonomous decentralized protocols. Transparent, zero-custody philanthropic infrastructure.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <motion.div
            style={{ scaleY }}
            className="absolute left-4 md:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-emerald-400 via-teal-400 to-cyan-400 -translate-x-1/2 origin-top shadow-[0_0_12px_rgba(16,185,129,0.5)]"
          />
            ...
            {PIPELINE_NODES.map((node, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 -translate-x-1/2 flex items-center justify-center w-8 h-8 rounded-full bg-[#000000] border border-white/[0.15] z-10">
                  ...
                  <div className={`w-full md:w-1/2 pl-12 md:pl-0 ${isEven ? 'md:pr-14' : 'md:pl-14'}`}>
                    ...
                    <div className="gradient-border rounded-xl p-6 sm:p-7 space-y-5 shadow-sm transition-all duration-300">
                      ...
                      <div className="flex items-center justify-between border-b border-white/[0.06] pb-4">
                        ...
                        <div className="w-6 h-6 rounded bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-slate-300">
