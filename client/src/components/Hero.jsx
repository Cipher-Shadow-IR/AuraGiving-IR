...
const Hero = ({ campaigns = [], onOpenHowItWorks, onOpenTutorial, onScrollToExplore }) => {
  ...
  return (
    <section className="relative pt-20 pb-20 lg:pt-28 lg:pb-28 border-b border-white/[0.06] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            >
              ...
              <span className="font-semibold">Direct EVM Pipeline</span>
              <span className="text-[#94A3B8]">/</span>
              <span className="text-[#94A3B8]">Zero Intermediary Fees</span>
            </motion.div>
            ...
            >
              ...
              <motion.p 
                variants={textRevealChild}
                className="text-sm sm:text-base text-[#94A3B8] max-w-xl leading-relaxed font-normal pt-3"
              >
            ...
            {/* Action Group: Primary Sapphire #3B82F6 CTA */}
            <motion.div 
            ...
            >
              <button
                ...
                className="btn-sheen flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-xs sm:text-sm font-semibold text-white bg-[#3B82F6] hover:bg-[#2563EB] transition-all duration-200 active:scale-95 shadow-md shadow-blue-500/20"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-xs sm:text-sm font-medium text-slate-200 bg-[#161B26] hover:bg-[#1C2331] border border-white/[0.1] transition-all active:scale-95"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-medium text-[#94A3B8] hover:text-white px-3 py-2 transition-colors ml-1"
              >
            ...
            {/* Tabular Stats Strip with Data Hierarchy (#94A3B8) */}
            <div className="pt-8 border-t border-white/[0.06] grid grid-cols-3 gap-6 max-w-lg">
              <div className="space-y-1">
                ...
                <p className="font-mono font-bold text-xl sm:text-2xl text-white">
                  {totalEthRaised} <span className="text-xs font-normal text-[#94A3B8]">ETH</span>
                </p>
              </div>
          ...
          {/* Right Column: Structured Featured Node (#161B26 Backing) */}
          {featured && (
            <motion.div 
            ...
            >
              <div className="gradient-border rounded-xl p-5 space-y-4 shadow-sm bg-[#161B26]">
                ...
                <div className="relative h-48 w-full rounded-lg overflow-hidden bg-[#0A0D14]">
                  <img
                    src={featured.image}
                    alt={featured.title}
                ...
                <div className="grid grid-cols-2 gap-2 pt-1">
                  <button
                    onClick={() => navigate(`/campaign-details/${encodeURIComponent(featured.title)}`, { state: featured })}
                    className="w-full py-2 px-3 rounded-lg text-xs font-medium text-slate-300 bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.08] transition-colors"
                  >
                    Inspect Story
                  </button>
                  ...
                  <button
                    ...
                    className="btn-sheen w-full py-2 px-3 rounded-lg text-xs font-semibold text-white bg-[#3B82F6] hover:bg-[#2563EB] transition-colors flex items-center justify-center gap-1.5 active:scale-95 shadow-sm"
                  >
